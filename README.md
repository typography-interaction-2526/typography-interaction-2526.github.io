...
For our inline uses, we landed on [Matthew Skala’s](https://ansuz.sooke.bc.ca) diligent conversion from [the Tsukurimashou Project](https://tsukurimashou.org/ocr.php.en), which [he notes](https://tsukurimashou.org/ocr.pdf) is itself descended from [Norbert Schwarz’s work](https://www.ctan.org/tex-archive/fonts/ocr-b) dating to the 80s. Most digital interpretations were a bit heavy for extended `<pre>` use, but we serendipitously found a (perhaps now abandoned) [lighter cut](https://web.archive.org/web/20191213001441/https://wehtt.am/ocr-b/), made by the [Matthew Hinders-Anderson](https://wehtt.am) for these same weight concerns. Coincidentally, Matthew’s other [non-commercial typefaces](https://wehtt.am/fonts/) are recent student (and [NYC](https://wehtt.am/#featured-work)) favorites!

### Build

*More to come, here! For now: [Zach Leatherman’s](https://www.zachleat.com/) sturdy site generator, [Eleventy](https://www.11ty.dev/).*
...
**We hope you can learn from it! Cheers.**
