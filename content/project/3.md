...
- [<cite>Project Nº 3: Reading Selections</cite>](TKTKTK)
...
Each text will ultimately live in its own subfolder, such as `repo/text-1/index.html`, with its own sibling `style.css`. For your initial sketching, you will be duplicating this HTML *three* times—in order to develop distinct typographic treatments for each instance.

Here we are focusing *solely* on typefaces, their hierarchy, vertical spacing, and your use of color. Do not use the same fonts in multiple directions. You should aim to have the designs of your website reflect the *overall* tone of your collection, and not any specific text alone.
