<script front-matter>
	const date = '2026-05-15' // Actual end of semester.
	const permalink = '/project/index/'
	const title = 'Index'
</script>
...
For this initial milestone, we want a aesthetic and functional *Minimum Viable Product* (MVP)—meaning it is not at all done, but it *works*—and can be “launched.” In our context, this means it has semantic HTML with at least your name, links to each of your three projects, and is responsively styled in CSS. Here we want to see some basic color, typography, and spacing/hierarchy considerations.
<!-- .balance -->
...
Work on this page will extend across the Spring semester, and it is due after everything else. It won’t be your primary focus—that will be your [fourth](/project/4/) and [fifth](/project/5/) projects—but we expect progress over the arc of the course.
...
- It should also contain some basic contact information, at least an email—but the more connections to your online presence, the better: your portfolio, social networks, GitHub profile, etc.
