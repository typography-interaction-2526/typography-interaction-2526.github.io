...
Think about a small/medium/large and we want a medium
What/unpack the challenges within that
Goal is to challenge yourself—tell us how

Submit chat history even if we don’t look at it -->
...
- Like any [*function*](https://en.wikipedia.org/wiki/Function_(computer_programming)), your project should take an *input* and have an *output*. It should *transform* the input, to answer the problem. (Ask yourself: what are my inputs; what are my outputs?)

- And again, your projects should be *achievable* and address *real* concerns. Where can you “make a dent?” We’ll have 7 weeks; can you approach it in that time?
<!-- .balance -->
...
<a :href="course.channel.submit"><cite>Submission Form</cite></a>
	Send us a link to your document!
...
1. Last, we want you to use this information to make a high-level, week-by-week roadmap—ending on the final presentation day, April 23. Use each week as a grouping; we only have five from today!
...
- [<cite>Project Nº 3: Planning Template</cite>](TKTKTK)
	[Duplicate this](https://help.figma.com/hc/en-us/articles/360038511533-Duplicate-or-copy-files#open-file) (don’t edit the shared one!), rename it with your name, and make sure it still “lives” in our class [project/folder](TKTKTK).
...
Every project will need something different here, but by April 1 you should be able to demonstrate your project’s core functionality in code. Prioritize this over aesthetics and other side quests.
...
This might mean your click-through prototype now saves state; this might mean you’re rendering or have populated all your data. It could be more progress into front-end, but that shouldn’t be at the expense of any *structure*. There should be no large implementation unknowns ahead of you—now is the time to resolve them. It might be ugly/default-y, or not have *all* of the features—but it should cover the core behaviors and use.
...
We also want you to *test* your project. (This has been lacking, before.) This means [using your DevTools](/topic/inspector/#device-mode) to thoroughly check screen sizes small and large—not just your own devices. This should also mean checking it on your phone, and on other computers. Send it to a classmate! All things equal, a thoroughly *working* project is worth more than any particular taste/design concept.
...
This is where you can get your [`<head>`](/topic/link-meta/) in order. Have someone proof your copy. Make sure your fonts work on another computer. Check those breakpoints (again). Maybe tackle one of your “nice to haves” that got cut for time! But do whatever else you need to make it feel *cohesive*, *intentional*, and *complete*—nothing left *rough* or *unfinished*. There should be no major shifts here, if you’ve met your milestones. This is a week to package it up, and then focus on your presentation. (Keep in mind [our notes](/week/22/#project-4-recap) from last time.)
...
- Your projects should be submitted as live, public URL&NoBreak;s
...
- As with last semester, *everyone’s* projects are due on the first day—next week, April 23. You will get the random presentation order that morning.
