...
- Include appropriate, considered [metadata](/topic/link-meta/) within you `<head>`.

- Also include a `README.md` overview of your project for Others/Future You (that *you* write).

- As before, projects will be submitted as live, public URL&NoBreak;s.
...
We will unpack the presentation format closer to the date!
<!-- .intro -->
