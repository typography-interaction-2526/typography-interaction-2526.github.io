...
<!-- We’ll unpack the rest of the milestones next week! .intro .before--2 -->
...
We’ll now *link* the Are&period;na channel to your static site—using its API to pull in its content directly. This will utilize JavaScript to dynamically render the page content from the channel, following [our example repo](https://github.com/typography-interaction-2526/links).
...
There should be no remaining local media or assets in your repo; everything should be coming dynamically from Are&period;na. You are welcome to continue to add blocks to your channel and refine it in the CMS there. We will then move our focus to refining the design and layout of the site, based on your actual content.
<!-- .before--2 -->
...
- We don’t want to see 20 Are&period;na reskins/generic templates—these should be unmistakeably *unique* to your collection and its theme.
